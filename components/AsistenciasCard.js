...
export const AsistenciasCard = ({ props }) => {
    ...
    return (
        <TouchableCmp onPress={() => navigation.navigate("DeportistaAssistance", dataProps.deportistum.nombres + " " + dataProps.deportistum.apellidos)}>
            <View style={styles.main}>
                ...
                <View style={styles.even1}>
                    <View>
                        <Text style={styles.cajaText1} numberOfLines={1}>{props.deportistum.nombres} {props.deportistum.apellidos}</Text>
                    </View>
